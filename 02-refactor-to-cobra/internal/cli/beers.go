...
func InitBeersStoresCmd() *cobra.Command {
	beersStoresCmd := &cobra.Command{
		Use:   "beers-stores",
		Short: "Print data about beers Stores",
		Run:   runBeersStoresFn(),
	}

	beersStoresCmd.Flags().StringP(idFlag, "i", "", "id of the shop")

	return beersStoresCmd
}
